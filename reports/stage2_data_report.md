# Báo cáo dữ liệu Phase 2 trước full build
...
| WildGuardTrain | — | — | — | — | — |
| **Subtotal hiện có** | **145.980** | **6.928** | **96.815** | **56.093** | **152.908** |
...
WildGuardTrain chưa được thống kê output vì dataset gated chưa có local. Số record chính thức của config train là 86.759, nhưng báo cáo không suy đoán số P/PR sau dedupe.
...
| WildGuardTrain | revision `d29c47f41c8b51348b5c8e8c81c039b3132b66d1`; chưa có file local |
...
`full_ready=false` cho tới khi có cả:

1. `input/stage2/wildguard/wildguardtrain.jsonl` từ config gated chính thức.
2. `work/benchmarks` đã chuẩn bị để builder lập hash và loại mọi overlap với test benchmark.
