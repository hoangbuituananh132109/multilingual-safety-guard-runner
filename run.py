...
def evaluate(config: dict[str, Any], model: dict[str, Any], checkpoint: str, method: str, mode: str, limit: int | None, sample: int | None, dry_run: bool, backend: str = "transformers", decoding_profile: str = "greedy", output_tag: str = "guard", tensor_parallel_size: int = 1, taxonomy_mode: str = "on", thinking_mode: str = "no_think") -> None:
...
def main() -> None:
    ...
    for command in ("evaluate", "likelihood"):
        ...
        if command == "evaluate":
            ...
            value.add_argument("--thinking-mode", choices=["no_think", "think"], default="no_think")
    ...
    if args.command == "preflight":
        ...
        if args.command == "evaluate":
            ...
            evaluate(config, model, args.checkpoint, args.method, args.run_mode, args.limit, args.sample, args.dry_run, backend, decoding_profile, args.output_tag, getattr(args, "gpus", 1), args.taxonomy_mode, args.thinking_mode)
